                  ...
                  <div className="space-y-6">
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <a href="mailto:hello@example.com" className="text-primary-500 hover:underline">hello@example.com</a>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <a href="https://linkedin.com/in/username" target="_blank" rel="noopener noreferrer" className="text-primary-500 hover:underline">
                  ...
                  <div className="mt-8">
                    ...
                    <div className="flex space-x-4">
                      <a 
                        ...
                        className="w-10 h-10 rounded-full bg-neutral-200 flex items-center justify-center text-neutral-700 hover:bg-primary-500 hover:text-white transition-colors"
                        aria-label="Twitter"
                      >
