          ...
          <div className="container mx-auto px-4 md:px-8">
            <div className="flex flex-col md:flex-row items-center gap-12">
              ...
              <div className="md:w-1/2 flex justify-center animate-on-scroll">
                <img src="https://github.com/erincfuller/erincfuller.github.io/blob/main/Foodbank-Hero.png?raw=true" alt="Find Food App on Laptop" className="w-auto h-auto max-w-full rounded-lg object-contain shadow-lg" />
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4 md:px-8">
            <div className="grid grid-cols-1 md:grid-cols-5 gap-8 items-center">
              ...
              <div className="md:col-span-2 animate-on-scroll">
                <img src="https://foodlinkny.org/wp-content/uploads/2020/11/Twitter-Map-of-Child-Food-Insecurity-1024x512.jpg" alt="Food Insecurity Map" className="rounded-lg w-full h-auto" />
        ...
        <section className="py-16 bg-neutral-100\n">
          <div className="container mx-auto px-4 md:px-8">
            ...
            <div className="text-center animate-on-scroll">
              <p className="text-neutral-700 mb-12 mx-auto max-w-3xl text-center">
        ...
        <section className="py-16 bg-neutral-50">
          <div className="container mx-auto px-4 md:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 animate-on-scroll">
              <div className="aspect-video bg-top bg-white p-4 rounded-lg border">
                <img src="https://github.com/erincfuller/erincfuller.github.io/blob/main/Foodbank-usertest.png?raw=true" alt="Desktop user testing session" className="rounded w-full h-full object-cover border" />
              ...
              <div className="aspect-video object-top bg-white p-4 rounded-lg border">
                <img src="https://github.com/erincfuller/erincfuller.github.io/blob/main/Foodbank-mobiletest2.png?raw=true" alt="Mobile prototypes" className="rounded w-full object-top" />
